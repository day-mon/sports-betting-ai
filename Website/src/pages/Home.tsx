      ...
      <section class="py-24 flex flex-col items-center justify-center">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 mt-4">
          ...
          <div class="bg-white rounded-lg shadow-lg p-4">
            ...
            <p class="text-gray-600">Our model was built using TensorFlow and Keras. With the use of past game data and 98 unique data points we can predict a games outcome with around 60-65% accuracy.</p>
          </div>
        </div>
      </section>
    </>
