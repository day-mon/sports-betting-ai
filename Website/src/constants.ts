...
export const MODEL_OPTIONS =
    [
        ...
        { key: 'ou', features: FEATURES, value: 'Over Under (Beta)', description: 'The Over Under model predicts the total score of the game. This model uses the same overall team statistics as the V1 & V2 model. '},
    ];
