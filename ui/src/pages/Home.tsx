    ...
    <>
      <main class="flex-1">
        <section class="bg-200 py-20 px-6 text-center">
          <h2 class="text-4xl font-bold mb-4 text-secondary">
            Welcome to NBA Predictor
          </h2>
          <p class="text-xl text-700 mb-8">
            Your go-to AI tool for NBA game predictions.
          </p>
        ...
        <section class="py-20 px-6">
          <h2 class="text-4xl font-bold text-center mb-8 text-secondary">
            Latest Predictions
          </h2>
